...
class ICMAgent(nn.Module):
    def __init__(self, hparams, num_players, action_descriptor, attn_target, attn_type, obs_space, feat_size,
                 reco_desc: RecoDescriptor, num_time, loc_feature_cnt, use_ppo=False, seed = 42):
        """
        ...
        self.a2c = A2CNet(self.num_envs, self.num_players, self.action_descriptor, obs_space, self.feat_size,
                          hparams.rollout_size, num_time, reco_desc, loc_feature_cnt, use_ppo, seed)
