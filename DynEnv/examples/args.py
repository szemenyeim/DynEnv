...
def get_args():
    ...
    parser.add_argument('--rollout-size', type=int, default=6, metavar='ROLLOUT_SIZE',
                        help='rollout size')
    parser.add_argument('--num-updates', type=int, default=40000, metavar='NUM_UPDATES',
    ...
    parser.add_argument('--long-horizon-coeff', type=float, default=1e-3, metavar='LONG_HORIZON_COEFF',
