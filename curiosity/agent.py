...
class ICMAgent(nn.Module):
    def __init__(self, n_stack, num_envs, num_players, action_descriptor, attn_target, attn_type, in_size, feat_size, lr=1e-4):
        """
        ...
        # networks
        self.icm = ICMNet(self.n_stack, self.num_players, self.action_descriptor, attn_type, attn_type, self.in_size,
                          self.feat_size)
        self.a2c = A2CNet(self.n_stack, self.num_players, self.action_descriptor, self.in_size, self.feat_size)
